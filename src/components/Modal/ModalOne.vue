    ...
    <div @click="open" class="w-full h-[180vh] bg-[#1E1E1E] bg-opacity-20 top-0 right-0 left-0 flex justify-center items-center fixed z-50 border-none outline-none font-jost">
        <div class="w-[90%] lg:w-[35%] 2xl:w-[30%] p-[24px] bg-black self-start mt-[50%] lg:mt-[20%] max-w-screen-md max-h-screen-xl">
            ...
            <div class="grid gap-[20px] mt-[26px]">
                <input type="text" :placeholder="$t('translation.modalOne.two')" class="outline-none bg-black border-b text-[#E3E7F2] border-[#E3E7F2]">
                <input type="tel" :placeholder="$t('translation.modalOne.three')" class="outline-none bg-black border-b text-[#E3E7F2] border-[#E3E7F2]">
            </div>
            <div class="flex items-center justify-between mt-[34px]">
                ...
                <div class="bg-black border border-[#E3E7F2] w-[120px] h-[120px] p-4 cursor-pointer">
