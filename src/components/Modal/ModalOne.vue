        ...
        <div class="w-[90%] lg:w-[35%] 2xl:w-[30%] p-[24px] bg-black self-start mt-[50%] lg:mt-[15%] max-w-screen-md max-h-screen-xl">
            ...
            <form >
                ...
                <div class="flex items-center justify-between mt-[34px]">
                    ...
                    <button type="submit" @onclick="submitForm" class="bg-black border border-[#E3E7F2] w-[120px] h-[120px] p-4 cursor-pointer hover:rounded-b-full hover:rounded-tl-full">
                        ...
                        <div class="grid gap-3 lg:gap-0 mt-[16px] lg:mt-[32px]">
                            <p class="text-[#E3E7F2] text-[14px] lg:text-[16px] font-jost proportional-nums leading-[14px] lg:w-[100%]">{{$t('translation.modal.one')}}</p>
                            <p class="text-[#E3E7F2] text-[14px] lg:text-[16px] font-jost proportional-nums leading-[14px] lg:w-[100%]">{{$t('translation.modal.two')}}</p>
                          </div>
                    </button>
                </div>
            </form>
